...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        next : $('<a>'+options.labelNext+'</a>').attr("onClick","siguiente()").addClass("btn btn-success botonMatriculaSig"),
        previous : $('<a>'+options.labelPrevious+'</a>').attr("href","#").addClass("btn btn-primary botonAnterior"),
        finish  : $('<a>'+options.labelFinish+'</a>').attr("onClick","onFinishCallback()").addClass("btn btn-default")
    };
