...
//echo '<pre>'; var_dump($resultadoObjeto); exit();
    ...
    function doRequestcargar_docente_por_carrera($datosCuenta,$source,$tipo,$usuario,$clave,$url,$host, $XML=NULL){
//echo "-----------------------------------------".$datosCuenta."--".$source."--".$tipo."--".$usuario."--".$clave."--".$url."--".$host."--";
   $post_string="
        <soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:ser=\"http://servicios.ug.edu.ec/\">
        <soapenv:Header/>
...
function doDocente_disponible($datosCuenta,$source,$tipo,$usuario,$clave,$url,$host, $XML=NULL){
//echo "-----------------------------------------".$datosCuenta."--".$source."--".$tipo."--".$usuario."--".$clave."--".$url."--".$host."--";
   $post_string="
        <soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:ser=\"http://servicios.ug.edu.ec/\">
        <soapenv:Header/>
...
function doRequestSolicitudes_disponible($datosCuenta,$source,$tipo,$usuario,$clave,$url,$host, $XML=NULL){
//echo "-----------------------------------------".$datosCuenta."--".$source."--".$tipo."--".$usuario."--".$clave."--".$url."--".$host."--";
   $post_string="
        <soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:ser=\"http://servicios.ug.edu.ec/\">
        <soapenv:Header/>
